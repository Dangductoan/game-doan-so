...
<div class="container">
    ...
    <div class="row justify-content-center">
          ...
          <h1 class="mt-5 text-danger">Xếp hạng</h1>
    ...
    <div class="row justify-content-center mt-5" >
        ...
        <div class="col-md-8">
            <table class="table table-borderless">
                <thead>
                <tr>
                    <th scope="col">ID màn chơi</th>
                    <th scope="col">Tên người chơi</th>
                    <th scope="col">Số lần đoán chính xác</th>
                    <th scope="col">Thời gian màn chơi</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach var="rating" items="${ratings}" varStatus="loop">
                            <tr class="table-rating">
